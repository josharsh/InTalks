...
public class NavTemp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button topicBtn = findViewById(R.id.topicButton1);
        Button genr = findViewById(R.id.genreButton1
        );
        ...
        topicBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent toTopicActivity = new Intent(NavTemp.this, TopicActivity.class);
        ...
        genr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toTTopicActivity = new Intent(NavTemp.this, NewMainActivity.class);
